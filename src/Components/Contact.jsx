...
const Contact = () => {
  return (
    <div className="relative min-h-screen bg-[#FCD9A4] flex flex-col items-center justify-center px-4 py-10">
      ...
      <div className="absolute top-0 left-0 w-full h-1/2 bg-[#E29642] z-0"></div>

      <div className="w-full z-10 relative bg-transparent py-10 text-center px-4">
        <h1 className="text-3xl md:text-4xl font-bold text-gray-900">
          Get In Touch
        </h1>
        <p className="text-sm md:text-base text-gray-800 mt-2 max-w-2xl mx-auto">
          We'd love to hear from you. Whether you have a question, idea, or just
          want to say hello — reach out and we’ll get back to you soon.
        </p>
      </div>
      ...
      <div className="flex flex-col-reverse lg:flex-row w-full max-w-6xl mt-10 rounded-xl shadow-2xl overflow-hidden z-10">
        ...
        <div className="bg-[#25262B] text-white w-full lg:w-1/2 p-6 flex flex-col justify-between gap-6">
          <div>
            ...
            <div className="flex items-center gap-2 mb-3">
              <span className="text-[#E29642]">📞</span>
              <span className="text-sm text-[#E29642]">+91 9316164924</span>
            </div>
            <div className="flex items-center gap-2 mb-3 break-all">
              <span className="text-[#E29642]">📧</span>
        ...
        {/* Right Side - Form */}
        <div className="bg-[#e0ab6e] w-full lg:w-1/2 p-6">
          ...
          <form className="flex flex-col gap-4">
            <input
              ...
              className="p-2 rounded-md border border-gray-300 w-full focus:outline-none"
            />
            ...
            <textarea
              ...
              className="p-2 rounded-md border border-gray-300 w-full h-32 resize-none focus:outline-none"></textarea>
            <button
              type="submit"
              className="bg-[#25262B] text-white py-2 rounded-md hover:opacity-90 w-full">
              Send
            </button>
          </form>
        </div>
