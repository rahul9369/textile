...
const AccountPage = () => {
  return (
    <div className="min-h-screen bg-[#FCD9A4] px-4 py-6 sm:px-6 md:px-10">
      ...
      {/* Form Section */}
      <div className="bg-[#E29642] p-4 sm:p-6 rounded-lg mb-6 grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div className="space-y-3">
          <div className="flex flex-col">
            <label className="bg-[#25262B] text-white text-sm px-3 py-1 rounded-t-md">
              Company Name
            </label>
            <input
              type="text"
              placeholder="Soumya International Textiles"
              className="w-full p-2 rounded-b-md border border-gray-300"
            />
          </div>
          <div className="flex flex-col">
            <label className="bg-[#25262B] text-white text-sm px-3 py-1 rounded-t-md">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="bg-[#25262B] text-white p-6 rounded-md flex flex-col justify-between">
          ...
          <p className="text-2xl font-bold text-[#E29642] mb-4">4500</p>

          {/* Inner Add Claw Coins Box */}
          <div className="bg-[#E29642] p-4 rounded-md">
        ...
        <div className="lg:col-span-2">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="border-2 border-black p-4 rounded-md">
              ...
              <h3 className="text-lg font-bold mb-2">ONE TIME</h3>
              ...
              <button className="bg-[#E29642] w-full py-2 text-white rounded-md hover:opacity-90">
                ACTIVE
              </button>
            </div>
